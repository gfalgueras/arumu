  ...
  <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
    <div class="bg-slate-900 border border-slate-700 rounded-lg w-full max-w-md overflow-hidden flex flex-col max-h-[80vh]">
      <div class="p-4 border-b border-slate-700 flex justify-between items-center bg-slate-800">
        <h2 class="text-lg font-semibold text-slate-100">Saved Connections</h2>
      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <form v-else @submit.prevent="handleSave" class="space-y-4 text-sm">
          <div class="space-y-2">
            <label class="text-slate-400 block">Name</label>
            <input 
              required
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-2">
              <label class="text-slate-400 block">Type</label>
              <select 
                class="w-full bg-slate-800 border border-slate-700 rounded p-2 text-slate-100 focus:outline-none focus:ring-1 focus:ring-blue-500"
            ...
            <div class="space-y-2">
              <label class="text-slate-400 block">Host</label>
              <input 
                required
                class="w-full bg-slate-800 border border-slate-700 rounded p-2 text-slate-100 focus:outline-none focus:ring-1 focus:ring-blue-500" 
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-2">
              <label class="text-slate-400 block">Port</label>
              <input 
                type="number"
                required
                class="w-full bg-slate-800 border border-slate-700 rounded p-2 text-slate-100 focus:outline-none focus:ring-1 focus:ring-blue-500" 
            ...
            <div class="space-y-2">
              <label class="text-slate-400 block">User</label>
              <input 
                required
                class="w-full bg-slate-800 border border-slate-700 rounded p-2 text-slate-100 focus:outline-none focus:ring-1 focus:ring-blue-500" 
          ...
          <div class="space-y-2">
            <label class="text-slate-400 block">Password</label>
            <input 
              type="password"
              class="w-full bg-slate-800 border border-slate-700 rounded p-2 text-slate-100 focus:outline-none focus:ring-1 focus:ring-blue-500" 
          ...
          <div class="space-y-2">
            <label class="text-slate-400 block">Default Database Filter (comma separated)</label>
            <input 
