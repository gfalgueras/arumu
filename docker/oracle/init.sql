...
-- Runs as SYSTEM in XEPDB1 after APP_USER (arumu_test) is created.
-- All objects are created in the ARUMU_TEST schema.
-- ============================================================

ALTER SESSION SET CURRENT_SCHEMA = ARUMU_TEST;
